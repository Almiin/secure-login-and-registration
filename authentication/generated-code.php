...
?>
        ...
        <head>
            ...
            <title>App-Generated Codes</title>
            <link
            rel="stylesheet"
            ...
            <div class="row">
                ...
                <div class="card-body px-lg-5 pt-4">
                    ...
                    <div id="img" class="text-center">
                        <img src='<?php echo $googleChartUri; ?>' />
                    </div>
                    ...
                    <div class="md-form">
                        ...
                        name="code"
                        />
                        <label for="code">Enter Google Authenticator Code</label>
                    </div>
        ...
        <script>
            ...
            $("#googleAuthForm").submit(function(event) {
                ...
                if(msg.status == "codeLength"){
                    toastr.error("Enter the six-digit google authenticator code.");
